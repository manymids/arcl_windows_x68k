...
#ifdef ARCL_OPM_SHADOW
/* ARCL (windows/arcl_opm.c): OPM register-write shadow for the Windows
 * ARCL frontend's L3 x68k_opm tool. See x68k_mcp.md 0.1.1 for why this
 * exists and the constraints it was written under (minimal diff,
 * behavior/codegen unchanged when ARCL_OPM_SHADOW is undefined). */
#include "arcl_opm.h"
#endif
...
#ifdef ARCL_OPM_SHADOW
		::arcl_opm_shadow_on_write(CurReg, data);
#endif
